...
#This will be super important later
import time
...
print("To start, you need to provide a peptide sequence. It can be upper or lower case, but should not contain spaces or special characters.")
sequence_raw = input("Please input your amino acid sequence: \n") 
sequence = sequence_raw.lower()
...
#The stuff that calls the function that does the math stuff
#Checking for correct sequences
